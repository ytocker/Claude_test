"""Render the design_2 BERSERKER review sheet: for each palette (IRONCLAD then
BLOODAXE) — a hero zoom, an in-gameplay panel, and a 40px NEAREST truth read.
Headless. Saves to docs/store_redesign/costume/viking/face/design_2/round_1.png.
"""
import os
...
OUT = "/home/user/skybit/docs/store_redesign/costume/viking/face/design_2/round_1.png"
...
for ri, (name, pal, build) in enumerate(ROWS):
    ...
    # 40px nearest truth read — scale the raw frame down to 40px then nearest-up.
    raw = build(2, 0.0)
