"""Compose the SKIRMISHER (design_5) round_2 review sheet: for EACH palette
...
from tools.viking_face_candidates.design_5 import build_ironclad, build_bloodaxe

OUT = "docs/store_redesign/costume/viking/face/design_5/round_2.png"
TITLE = ("DESIGN 5 — SKIRMISHER  (almond eye + thin pointed mustache + bearded "
         "goatee + bead; light hatchet held FORWARD, ready-to-throw)")
