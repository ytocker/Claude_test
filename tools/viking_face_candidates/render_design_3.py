"""Compose the RAIDER (design_3) review sheet: for EACH palette
...
OUT = "docs/store_redesign/costume/viking/face/design_3/round_1.png"
TITLE = "DESIGN 3 — RAIDER  (braided mustache into one long rope-braid beard + held tall Dane-axe)"
