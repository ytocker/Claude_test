"""Bottom-frame gems — option A: full-raise.

Shelf and ALL contents raised ~25px to give bottom gems maximum clearance.
SHELF_Y=210, CHIP_CY=238, BTN_CY=268 (was 235/258/302).
Bottom gems at cy=309 have 15px clearance below button bottom (268+15=283, gem top=298).

Sheet: left=AFFORDABLE, right=UNAFFORDABLE, 444×412
Output → docs/store_confirm_shelf_v3/bottom-gems/full-raise/round_1.png
"""
import os, sys, math
...
# Option A: raise shelf + all contents ~25px
SHELF_X, SHELF_Y, SHELF_W, SHELF_H = 13, 210, 174, 87
CHIP_CY                            = 238
...
draw.text((CANVAS_W // 2, MARGIN + HDR_H // 2),
          "Bottom gems A: full-raise  |  AFFORDABLE / UNAFFORDABLE",
...
OUT = os.path.abspath(os.path.join(os.path.dirname(__file__), "..",
      "docs", "store_confirm_shelf_v3", "bottom-gems", "full-raise", "round_1.png"))
canvas.save(OUT)
