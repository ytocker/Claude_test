"""Render the Design 6 (Spore-Burst Host Body) R1 review sheet: gameplay panel,
hero product-shot, and a 40px NEAREST truth-read, labelled and committed to
docs/store_redesign/costume/zombie/design_6/round_1.png."""
import os
...
from tools.zombie_candidates.design_6 import build

OUT = "docs/store_redesign/costume/zombie/design_6/round_1.png"
...
title = font_big.render("DESIGN 6 — SPORE-BURST HOST BODY", True, (232, 236, 210))
