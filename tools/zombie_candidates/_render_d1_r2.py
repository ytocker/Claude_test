"""Render the Design 1 (Roadkill Fresh-Turned) round-2 sheet."""
import os
...
spec = importlib.util.spec_from_file_location(
    "zombie_d1", os.path.join(os.path.dirname(__file__), "design_1.py"))
...
title = font.render("DESIGN 1 — ROADKILL FRESH-TURNED · R2", True, (236, 232, 224))
...
out = os.path.join(os.path.dirname(__file__), "..", "..",
                   "docs", "store_redesign", "costume", "zombie", "design_1", "round_2.png")
