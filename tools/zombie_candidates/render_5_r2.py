"""Render the Design 5 (Bloated Gas-Bag) R2 review sheet: gameplay panel,
hero product-shot, and a 40px NEAREST truth-read, labelled and committed to
docs/store_redesign/costume/zombie/design_5/round_2.png."""
import os
...
from tools.zombie_candidates.design_5 import build

OUT = "docs/store_redesign/costume/zombie/design_5/round_2.png"
...
title = font_big.render("DESIGN 5 — BLOATED GAS-BAG · R2", True, (232, 236, 210))
