"""Render the Design 10 (Greasepaint Grave Jester) round sheet."""
import os
...
from tools.ninja_render import gameplay_panel, hero_panel, FRAME_IDX

spec = importlib.util.spec_from_file_location(
    "zombie_d10", os.path.join(os.path.dirname(__file__), "design_10.py"))
...
title = font.render("DESIGN 10 — GREASEPAINT GRAVE JESTER", True, (236, 232, 224))
...
out = os.path.join(os.path.dirname(__file__), "..", "..",
                   "docs", "store_redesign", "costume", "zombie", "design_10", "round_1.png")
