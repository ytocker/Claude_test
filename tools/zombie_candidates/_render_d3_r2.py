"""Render the Design 3 (Voodoo Hex Bird) round-2 review sheet.

Same three-column layout as round 1: an in-gameplay panel, a clean hero box,
and a 40px NEAREST truth-read (down to 40x40 then back up 5x) so the shrink
read that decides a costume is judged honestly.
"""
import os
...
OUT = "docs/store_redesign/costume/zombie/design_3/round_2.png"
...
title = font_big.render("DESIGN 3 — VOODOO HEX BIRD · R2", True, (196, 255, 206))
