"""Render the Design 7 (Charred Ember Revenant) review sheet: gameplay panel,
hero product-shot, and a 40px NEAREST truth-read, labelled and committed to
docs/store_redesign/costume/zombie/design_7/round_1.png."""
import os
...
from tools.zombie_candidates.design_7 import build

OUT = "docs/store_redesign/costume/zombie/design_7/round_1.png"
...
title = font_big.render("DESIGN 7 — CHARRED EMBER REVENANT", True, (232, 236, 210))
