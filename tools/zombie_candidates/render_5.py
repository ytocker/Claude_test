"""Render the Design 5 (Bloated Gas-Bag) review sheet: gameplay panel,
hero product-shot, and a 40px NEAREST truth-read, labelled and committed to
docs/store_redesign/costume/zombie/design_5/round_1.png."""
import os
...
OUT = "docs/store_redesign/costume/zombie/design_5/round_1.png"
...
title = font_big.render("DESIGN 5 — BLOATED GAS-BAG", True, (232, 236, 210))
