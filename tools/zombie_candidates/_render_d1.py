"""Render the Design 1 (Roadkill Fresh-Turned) round sheet."""
import os
...
title = font.render("DESIGN 1 — ROADKILL FRESH-TURNED", True, (236, 232, 224))
...
out = os.path.join(os.path.dirname(__file__), "..", "..",
                   "docs", "store_redesign", "costume", "zombie", "design_1", "round_1.png")
