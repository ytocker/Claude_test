"""Render the Design 2 (Ancient Crypt Rot) round-2 sheet."""
import os
...
spec = importlib.util.spec_from_file_location(
    "zombie_d2", os.path.join(os.path.dirname(__file__), "design_2.py"))
...
title = font.render("DESIGN 2 — ANCIENT CRYPT ROT · R2", True, (236, 232, 224))
...
out = os.path.join(os.path.dirname(__file__), "..", "..",
                   "docs", "store_redesign", "costume", "zombie", "design_2", "round_2.png")
