"""Render the Design 2 (Ancient Crypt Rot) round sheet."""
import os
...
title = font.render("DESIGN 2 — ANCIENT CRYPT ROT", True, (236, 232, 224))
...
out = os.path.join(os.path.dirname(__file__), "..", "..",
                   "docs", "store_redesign", "costume", "zombie", "design_2", "round_1.png")
