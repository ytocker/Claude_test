"""gem-cradle-tab layout options showcase — A / B / C."""
...
PANELS = [
    ("A", "opt-a", "docs/store_confirm_shelf_v3/shelf-redesign/gem-cradle-tab/opt-a/round_1.png"),
    ("B", "opt-b", "docs/store_confirm_shelf_v3/shelf-redesign/gem-cradle-tab/opt-b/round_1.png"),
    ("C", "opt-c", "docs/store_confirm_shelf_v3/shelf-redesign/gem-cradle-tab/opt-c/round_1.png"),
]
...
def main():
    ...
    title = "gem-cradle-tab — layout options"
