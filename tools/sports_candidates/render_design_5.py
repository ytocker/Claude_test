"""Compose the THE ACE review sheet (hero + gameplay + 40px truth read).
...
from tools.sports_candidates.design_5 import build

OUT = "docs/store_redesign/costume/sports/design_5/round_5.png"
TITLE = "DESIGN 5 — THE ACE (Tennis)  round 5 (one clean racket + polo off the face)"
