"""Compose the D3 ROLLER GROOVE round-2 review sheet.

Same three reads as R1 so the revision is judged the way it ships: a clean
...
Headless: SDL_VIDEODRIVER=dummy SDL_AUDIODRIVER=dummy python -m tools.disco_candidates.render_3_r2
"""
import os
...
OUT = "docs/store_redesign/costume/disco/design_3/round_2.png"
TITLE = "D3 ROLLER GROOVE — R2"
