"""Compose the BOOGIE NIGHTS (Disco D1) round-1 review sheet.
...
Headless: SDL_VIDEODRIVER=dummy SDL_AUDIODRIVER=dummy \
    python -m tools.disco_candidates.render_1_r1
"""
import os
...
OUT = "docs/store_redesign/costume/disco/design_1/round_1.png"
TITLE = "D1 BOOGIE NIGHTS — R1  (Saturday Night Fever floor-filler)"
