"""Render the D2 STARDUST DIVA round-2 review sheet.

Same three reads as R1 so the R1→R2 revision is judged like-for-like: an
in-gameplay crop (the true 40px-ish read over a live daytime scene), a clean
hero product-shot, and a hard 40px "truth" downscale to catch anything that
muds out at store-card size.
"""
import os
...
sheet.blit(font.render("D2 STARDUST DIVA — R2", True, (245, 240, 250)),
           (PAD, 16))
...
out = "docs/store_redesign/costume/disco/design_2/round_2.png"
