"""Compose the BOOGIE NIGHTS (Disco D1) round-2 review sheet.
...
Headless: SDL_VIDEODRIVER=dummy SDL_AUDIODRIVER=dummy \
    python -m tools.disco_candidates.render_1_r2
"""
import os
...
OUT = "docs/store_redesign/costume/disco/design_1/round_2.png"
TITLE = "D1 BOOGIE NIGHTS — R2  (espresso afro + clean V-lapel + bold medallion)"
