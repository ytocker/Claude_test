"""Compose the BOOGIE NIGHTS (Disco D1) round-3 review sheet.
...
Headless: SDL_VIDEODRIVER=dummy SDL_AUDIODRIVER=dummy \
    python -m tools.disco_candidates.render_1_r3
"""
import os
...
OUT = "docs/store_redesign/costume/disco/design_1/round_3.png"
TITLE = "D1 BOOGIE NIGHTS — R3 (afro fwd + medallion raised + lapels on body)"
