"""Compose the BOOGIE NIGHTS (Disco D1) round-6 review sheet.
...
Headless: SDL_VIDEODRIVER=dummy SDL_AUDIODRIVER=dummy \
    python -m tools.disco_candidates.render_1_r6
"""
import os
...
OUT = "docs/store_redesign/costume/disco/design_1/round_6.png"
TITLE = "D1 BOOGIE NIGHTS — R6 (afro anchored, contrast, medallion)"
