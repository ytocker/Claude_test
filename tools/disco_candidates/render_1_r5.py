"""Compose the BOOGIE NIGHTS (Disco D1) round-5 review sheet.
...
Headless: SDL_VIDEODRIVER=dummy SDL_AUDIODRIVER=dummy \
    python -m tools.disco_candidates.render_1_r5
"""
import os
...
OUT = "docs/store_redesign/costume/disco/design_1/round_5.png"
TITLE = "D1 BOOGIE NIGHTS — R5 (jacket rebuilt side-profile)"
