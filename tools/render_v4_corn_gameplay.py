"""Render the 5 V4 corn-dog picker variants as full-frame gameplay shots.

Output:
  docs/kfc_pillar_variants/v4_corn/v4_corn1..5.png
  docs/kfc_pillar_variants/v4_corn/compare.png

Run from the repo root:

    PYTHONPATH=. python tools/render_v4_corn_gameplay.py
"""
import math
import os
import random
...
from render_v4_corn_variants import install_variant, V4_CORN_VARIANTS  # noqa: E402
...
def main():
    ...
    out_dir = os.path.join("docs", "kfc_pillar_variants", "v4_corn")
    os.makedirs(out_dir, exist_ok=True)

    full_frames = {}

    for key in V4_CORN_VARIANTS:
        label, _ = V4_CORN_VARIANTS[key]
    ...
    items = list(V4_CORN_VARIANTS.items())
    n = len(items)
