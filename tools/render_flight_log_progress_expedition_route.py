...
def main():
    ...
    screen = build_skybit_bg(360, 640)
    parchment = render_screen()
    add_cartouche_glyphs(parchment)
    doc = pygame.transform.smoothscale(parchment, (330, 590))
    shadow = pygame.Surface((330, 590), pygame.SRCALPHA)
    shadow.fill((0, 0, 8, 110))
    screen.blit(shadow, (17, 27))
    screen.blit(doc, (15, 25))

    out = os.path.join(ROOT, "docs", "flight_log_progress",
                       "expedition_route", "round_3.png")
