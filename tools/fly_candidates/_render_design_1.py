...
for fi in range(4):
    ...
    pygame.draw.rect(hp, (10, 22, 18), hp.get_rect(), border_radius=14)
...
os.makedirs("/home/user/skybit/docs/store_redesign/animal/fly/design_1", exist_ok=True)
pygame.image.save(sheet, "/home/user/skybit/docs/store_redesign/animal/fly/design_1/round_1.png")
print("Saved")
