...
import pygame
pygame.init()
from tools.fly_candidates.design_2 import build
...
for fi in range(4):
    ...
    fr40 = pygame.transform.scale(fr, (40, h))   # NEAREST
...
out = "/home/user/skybit/docs/store_redesign/animal/fly/design_2/round_2.png"
