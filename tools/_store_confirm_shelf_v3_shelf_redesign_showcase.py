"""Shelf redesign — 4 concept directions showcase."""
...
def main():
    ...
    title = "Bottom shelf redesign — concept directions"
    ...
    out_dir = os.path.join(BASE, "docs/store_confirm_shelf_v3/shelf-redesign")
