"""Headless 10x12 exploration sheet for the round-8 fresh sky concepts.
...
into `docs/biome_redesign/round_8.png`. Larger cells than the old port-check
...
def main():
    ...
    title = f_title.render("Skybit sky concepts — round 8 (10 fresh)", True, (245, 246, 250))
    ...
    out = os.path.join(os.path.dirname(os.path.dirname(os.path.abspath(__file__))),
                       "docs", "biome_redesign", "round_8.png")
