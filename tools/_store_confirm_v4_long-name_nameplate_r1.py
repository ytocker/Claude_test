#!/usr/bin/env python3
"""
nameplate  ·  store buy-confirmation popup v4  ·  long-name overflow  ·  round 1
...
def _patched_draw_confirm(self, surf):
    ...
    # plate fill: neutral indigo gradient (NOT tier-tinted)
    plate_stops = [(0.0, (36, 34, 62)), (1.0, (24, 22, 48))]
    plate_surf = sc.vgrad_stops(plate_rect.w, plate_rect.h, plate_rad,
                                plate_stops, 255)

    # deboss: dark top-inner edge (engraved) + bright bottom-inner edge
    pygame.draw.line(plate_surf, (18, 16, 34),
                     (plate_rad, 1), (plate_rect.w - plate_rad, 1), 1)
    pygame.draw.line(plate_surf, (58, 54, 90),
                     (plate_rad, plate_rect.h - 2),
                     (plate_rect.w - plate_rad, plate_rect.h - 2), 1)
...
hdr = fhdr.render("NAMEPLATE · Long-name overflow R1", True, GOLD)
...
OUT = os.path.join(os.path.dirname(__file__), "..", "docs",
                   "store_confirm_popup_v4", "long-name", "nameplate", "round_1.png")
