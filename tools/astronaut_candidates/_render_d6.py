...
def main():
    ...
    title = FONT.render("DESIGN 6  ·  ARTEMIS  —  next-gen NASA AxEMU moon suit", True, (240, 242, 250))
    ...
    out = "/home/user/skybit/docs/store_redesign/costume/astronaut/design_6/round_1.png"
