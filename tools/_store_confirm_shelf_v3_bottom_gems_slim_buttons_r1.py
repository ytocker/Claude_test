"""Bottom-frame gems — option C: slim-buttons.

Shrink button height to 24 (was 30) and raise shelf slightly.
SHELF_Y=232, CHIP_CY=245, BTN_H=24, BTN_CY=272.
Bottom gems at cy=309 have 13px clearance below button bottom (272+12=284, gem top=298).

Sheet: left=AFFORDABLE, right=UNAFFORDABLE, 444×412
Output → docs/store_confirm_shelf_v3/bottom-gems/slim-buttons/round_1.png
"""
import os, sys, math
...
# Option C: slim buttons (BTN_H=24) + slight raise
SHELF_X, SHELF_Y, SHELF_W, SHELF_H = 13, 232, 174, 87
CHIP_CY                            = 245
...
draw.text((CANVAS_W // 2, MARGIN + HDR_H // 2),
          "Bottom gems C: slim-buttons  |  AFFORDABLE / UNAFFORDABLE",
...
OUT = os.path.abspath(os.path.join(os.path.dirname(__file__), "..",
      "docs", "store_confirm_shelf_v3", "bottom-gems", "slim-buttons", "round_1.png"))
canvas.save(OUT)
