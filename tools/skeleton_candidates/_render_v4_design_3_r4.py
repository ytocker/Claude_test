"""Compose the v4 design_3 (NEON / BIOLUMINESCENT · cloaked) round_4 sheet.

Cloak revision: a dark cloth margin is now reserved AROUND the glowing skeleton
(the bone bloom is walled out of a near-black silhouette band), with a hard cyan
cowl-front rim and a tattered-hem under-rim, so at 40px on the NIGHT sky the read
is "hooded skeleton in a cloak", not "a glowing blob". Show it in a real gameplay
scene DAY + NIGHT, a hero product shot, and a 40px NEAREST truth read on both
skies.
"""
import os
...
OUT = "docs/store_redesign/costume/skeleton/v4/design_3/round_4.png"
...
sheet.fill((10, 11, 18))
sheet.blit(font.render("v4 SKELETON · design_3 R4 — NEON / BIOLUMINESCENT (cloaked)",
