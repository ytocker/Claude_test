"""Render the round_1 review sheet for skeleton design_4 (DEADMAN'S FLAG).
...
def main():
    ...
    title = font.render("SKELETON design_4 — DEADMAN'S FLAG — round 1",
                        True, (244, 239, 224))
    ...
    out = "docs/store_redesign/costume/skeleton/design_4/round_1.png"
