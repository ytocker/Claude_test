"""Compose the v4 design_2 (BOLD CARTOON BONE + CLOAK) round_5 review sheet.

Round_5 is the RIBCAGE pass: the chosen winner's chest read as a few straight
diagonal slashes over a white blob, not a cage. This sheet is the audit for the
rebuilt ribcage — a rounded basket of ~6 even curved rib arcs springing off the
spine and converging on a deep sternum/keel, with dark flesh between every rib
and a dark moat walling the cage off from the pelvis/leg mass below.
...
OUT = "docs/store_redesign/costume/skeleton/v4/design_2/round_5.png"
...
sheet.blit(font.render(
    "v4 SKELETON · design_2 R5 — RIBCAGE rebuilt (spine -> 6 curved arcs -> keel, dark gaps, walled off pelvis)",
