"""Compose the v4 design_4 (IVORY ANATOMICAL) round_1 review sheet (scratch)."""
import os
...
OUT = "docs/store_redesign/costume/skeleton/v4/design_4/round_1.png"
...
label(sheet, "warm natural-history bone plate of the original Pip · countable ribs · "
             "vertebra knobs · wing phalanges · long hooked beak-bone hero", 16, 36)
