"""Render the v2 AUREX-MACAW (v2_design_5) round-1 review sheet — scratch only.
...
OUT = "docs/store_redesign/costume/skeleton/v2/design_5/round_1.png"
...
def main():
    ...
    sheet.blit(pygame.font.SysFont("dejavusans", 26, bold=True).render(
        "SKELETON v2 — design_5  AUREX-MACAW  (cursed gold-lich)  round 1", True, BONE),
        (pad, 12))
