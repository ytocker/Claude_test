"""Compose the v4 design_2 (BOLD CARTOON BONE + CLOAK) round_3 review sheet.
...
cloaked back mass (hood + drape + hem) still reads as a cloak at thumbnail size
while the skull + dominant beak + ribcage stay the hero.
"""
import os
...
OUT = "docs/store_redesign/costume/skeleton/v4/design_2/round_3.png"
...
def night_gameplay_panel(source, w, h):
    ...
    the near-black cloak is judged against navy, not only bright day sky."""
...
sheet.blit(font.render(
    "v4 SKELETON · design_2 R3 — BOLD CARTOON BONE + HOODED CLOAK", True,
    (250, 252, 255)), (16, 12))
...
label(sheet, "NIGHT gameplay (navy phase)", 632, 440)
