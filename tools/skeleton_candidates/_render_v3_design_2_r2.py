"""Round-2 review sheet for v3_design_2 · X-RAY.

Headless: SDL_VIDEODRIVER=dummy PYTHONPATH=. python tools/skeleton_candidates/_render_v3_design_2_r2.py
"""
import os
...
def main():
    ...
    y0 = 46
    _label(sheet, font, "v3_design_2 · X-RAY — full skeleton (Round 2)", M, 14)
    ...
    out = "docs/store_redesign/costume/skeleton/v3/design_2/round_2.png"
