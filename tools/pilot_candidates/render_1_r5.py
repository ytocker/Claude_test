...
lbl  = _font(18, True).render("D1 CAPTAIN — R5 (navy body + anatomy collar)", True, _GOLD_PALE)
tlbl = _font(13, True).render("40px: navy oval body = jacket; red head stays natural", True, _GOLD_PALE)
sheet.blit(lbl,  (10, 4))
sheet.blit(tlbl, (560, 232))
os.makedirs("docs/store_redesign/costume/pilot/design_1", exist_ok=True)
pygame.image.save(sheet, "docs/store_redesign/costume/pilot/design_1/round_5.png")
print("SAVED")
