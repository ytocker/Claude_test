...
# NEAREST double-scale (40px truth read): the bar is "reads as airline captain at 40px".
...
lbl = _font(18, True).render("D1 CAPTAIN — R2", True, _GOLD_PALE)
sheet.blit(lbl, (10, 4))
tlbl = _font(13, True).render("40px truth-read: airline captain?", True, _GOLD_PALE)
sheet.blit(tlbl, (560, 232))
os.makedirs("docs/store_redesign/costume/pilot/design_1", exist_ok=True)
pygame.image.save(sheet, "docs/store_redesign/costume/pilot/design_1/round_2.png")
print("SAVED")
