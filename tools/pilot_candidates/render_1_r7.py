...
lbl = _font(18, True).render("D1 CAPTAIN — R7 (epaulette only)", True, _GOLD_PALE)
sheet.blit(lbl, (10, 4))
tlbl = _font(13, True).render("40px truth-read: single rank item on shoulder", True, _GOLD_PALE)
sheet.blit(tlbl, (560, 232))
os.makedirs("docs/store_redesign/costume/pilot/design_1", exist_ok=True)
pygame.image.save(sheet, "docs/store_redesign/costume/pilot/design_1/round_7.png")
print("SAVED")
