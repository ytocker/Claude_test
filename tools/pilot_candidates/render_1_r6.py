...
# NEAREST double-scale (40px truth read): round shades on face, epaulette on shoulder?
...
lbl = _font(18, True).render("D1 CAPTAIN — R6 (round shades + shoulder epaulette)", True, _GOLD_PALE)
sheet.blit(lbl, (10, 4))
tlbl = _font(13, True).render("40px truth-read: round shades on face, epaulette on shoulder?", True, _GOLD_PALE)
sheet.blit(tlbl, (560, 232))
os.makedirs("docs/store_redesign/costume/pilot/design_1", exist_ok=True)
pygame.image.save(sheet, "docs/store_redesign/costume/pilot/design_1/round_6.png")
print("SAVED")
