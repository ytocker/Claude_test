...
def truth_read(phase, box=200, px=40):
    ...
    silhouette + three-value read can be judged at gameplay size on day/night."""
...
lbl = _font(18, True).render("D2 ACE — R2", True, _GOLD_PALE)
sheet.blit(lbl, (10, 8))
bar = _font(13, False).render(
    "reads as WW1/WW2 dogfighter ace with trailing scarf at 40px", True, (210, 200, 220))
...
pygame.image.save(sheet, "docs/store_redesign/costume/pilot/design_2/round_2.png")
print("SAVED")
