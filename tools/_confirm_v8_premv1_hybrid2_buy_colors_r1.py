"""hybrid-2 BUY colour round_1 — five backgrounds at the locked B2 size.
...
OPTIONS = [
    ("Y1 · bullion match", G2,
     GOLD_A_RIM_DARK, GOLD_A_RIM_BRIGHT, GOLD_A_NUM),
    ("Y2 · deep amber (cur)", [(0.0, (120, 75, 18)), (1.0, (80, 45, 8))],
     GOLD_A_RIM_DARK, GOLD_A_RIM_BRIGHT, (255, 248, 220)),
    ("Y3 · tier gem", [(0.0, (174, 108, 228)), (1.0, (96, 44, 150))],
     (54, 22, 92), (232, 196, 255), (255, 252, 255)),
    ("Y4 · emerald go", [(0.0, (88, 182, 104)), (1.0, (26, 102, 48))],
     GOLD_A_RIM_DARK, GOLD_A_RIM_BRIGHT, (240, 255, 240)),
    ("Y5 · royal crimson", [(0.0, (198, 88, 62)), (1.0, (118, 36, 22))],
     GOLD_A_RIM_DARK, GOLD_A_RIM_BRIGHT, (255, 240, 230)),
]
...
def main():
    ...
    try:
        ...
        idr.text((MARGIN, 18),
                 "hybrid-2 BUY colour round_1 · B2 buttons 99x42 · EPIC",
                 fill=(236, 214, 160))
