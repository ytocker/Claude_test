...
def build_screen():
    ...
    # A pool of the death sky behind the document so the cream doesn't float on
    # a flat field.
    glow = pygame.Surface((64, 64), pygame.SRCALPHA)
    warm = _tint(DEATH_SKY, 0.55)
    for i in range(32, 0, -1):
        pygame.draw.circle(glow, (*warm, 5), (32, 32), i)
    scr.blit(pygame.transform.smoothscale(glow, (440, 600)), (-40, 30))
