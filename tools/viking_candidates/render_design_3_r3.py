"""Compose the SHIELDMAIDEN FREYA round-3 review sheet: hero shot + in-gameplay
crop + a 40px truth read (NEAREST-shrink to 40px, magnified 3x). Save under docs/.
"""
import os
...
OUT = "/home/user/skybit/docs/store_redesign/costume/viking/design_3/round_3.png"
...
def main():
    ...
    _label(sheet, "design_3 · round_3 · SHIP-READY + beauty pass: braid roots "
                  "splayed +2px Y (two plaits read at hero zoom) + shield sheen "
                  "stepped down toward TEAL (gold boss owns the hotspot) · "
