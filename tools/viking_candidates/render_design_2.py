"""Compose the design_2 (JARL GULLHELM) viking review sheet: hero shot +
in-gameplay panel + a NEAREST-neighbour 40px "truth read" magnified 3x.
Headless only — reuses the shared ninja_render harness.
"""
import os
...
OUT = "docs/store_redesign/costume/viking/design_2/round_1.png"
TITLE = "JARL GULLHELM — The Golden King-Jarl  (viking design_2)"
...
def main():
    ...
    _label(sheet, "gilded crested spangenhelm · wide wolf-fur ruff collar · "
                  "blonde braid w/ gold beard-rings · drinking horn + arm-ring torcs",
           22, 42, sz=13, col=SUB)
