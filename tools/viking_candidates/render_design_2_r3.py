"""Compose the design_2 (JARL GULLHELM) viking ROUND 3 review sheet: hero shot
...
OUT = "docs/store_redesign/costume/viking/design_2/round_3.png"
TITLE = "JARL GULLHELM — The Golden King-Jarl  (viking design_2 · ROUND 3)"
...
def main():
    ...
    _label(sheet, "rear-coverage SEAL: zero scarlet/underwing-blue across all 4 "
                  "wing frames · nape gap closed under the helm brow",
           22, 42, sz=12, col=SUB)
