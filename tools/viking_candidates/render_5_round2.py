"""Compose the ODINWING ROUND 2 review sheet (hero + in-gameplay + 40px truth
read + 4-frame shimmer filmstrip) and save it to
docs/store_redesign/costume/viking/design_5/round_2.png.
...
ninja_render harness (production art untouched). Run headless:
  SDL_VIDEODRIVER=dummy PYTHONPATH=/home/user/skybit python tools/viking_candidates/render_5_round2.py
"""
import os
...
OUT = "/home/user/skybit/docs/store_redesign/costume/viking/design_5/round_2.png"
...
def main():
    ...
    _label(sheet, "Allfather Valkyrie Helm  ·  LEGENDARY  ·  viking redesign / design_5  ·  ROUND 2",
           30, 64, 18, GOLD)
