"""Compose the FROSTREAVER review sheet (hero + gameplay + 40px truth read).
...
OUT = "docs/store_redesign/costume/viking/design_4/round_1.png"
TITLE = "DESIGN 4 — FROSTREAVER  (Ice-Raider of the North)"
