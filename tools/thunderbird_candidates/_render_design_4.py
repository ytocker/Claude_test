"""Stitch the Design 4 (NIGHT THUNDER) round-1 review sheet."""
import os
...
title = pygame.font.SysFont("arial", 22, bold=True).render(
    "THUNDERBIRD — Design 4: NIGHT THUNDER (Round 1)", True, (200, 180, 255))
...
out = "/home/user/skybit/docs/store_redesign/animal/thunderbird/design_4/round_1.png"
