"""Round-1 review sheet for thunderbird LIVE WIRE (design_10)."""
import os
...
from tools.thunderbird_candidates.design_10 import build

OUT = "/home/user/skybit/docs/store_redesign/animal/thunderbird/design_10/round_1.png"
...
title = pygame.font.SysFont("dejavusans", 18, bold=True).render(
    "THUNDERBIRD  —  Design 10: LIVE WIRE  (Round 1)", True, (255, 243, 176))
