"""Round-1 review sheet for thunderbird CIRCUIT RAPTOR (design_8)."""
import os
...
OUT = "/home/user/skybit/docs/store_redesign/animal/thunderbird/design_8/round_1.png"
...
title = pygame.font.SysFont("dejavusans", 18, bold=True).render(
    "THUNDERBIRD  —  Design 8: CIRCUIT RAPTOR  (Round 1)", True, (217, 255, 246))
