"""Round-2 review sheet for thunderbird LIVE WIRE (design_10)."""
import os
...
OUT = "/home/user/skybit/docs/store_redesign/animal/thunderbird/design_10/round_2.png"
...
title = pygame.font.SysFont("dejavusans", 18, bold=True).render(
    "THUNDERBIRD  —  Design 10: LIVE WIRE  (Round 2)", True, (255, 243, 176))
