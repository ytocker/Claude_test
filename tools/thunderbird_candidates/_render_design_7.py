"""Round-1 review sheet for thunderbird BALL LIGHTNING (design_7)."""
import os
...
OUT = "/home/user/skybit/docs/store_redesign/animal/thunderbird/design_7/round_1.png"
...
title = pygame.font.SysFont("dejavusans", 18, bold=True).render(
    "THUNDERBIRD  —  Design 7: BALL LIGHTNING  (Round 1)", True, (255, 243, 176))
