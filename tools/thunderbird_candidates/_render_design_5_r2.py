"""Round-2 review sheet for thunderbird ANCESTRAL SPIRIT (design_5)."""
import os
...
OUT = "/home/user/skybit/docs/store_redesign/animal/thunderbird/design_5/round_2.png"
...
title = pygame.font.SysFont("dejavusans", 18, bold=True).render(
    "THUNDERBIRD  —  Design 5: ANCESTRAL SPIRIT  (Round 2)", True, (217, 255, 246))
