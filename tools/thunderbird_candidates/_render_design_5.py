"""Round-1 review sheet for thunderbird ANCESTRAL SPIRIT (design_5)."""
import os
...
from tools.thunderbird_candidates.design_5 import build

OUT = "/home/user/skybit/docs/store_redesign/animal/thunderbird/design_5/round_1.png"
...
truth = pygame.transform.scale(truth_src, (tw, th))  # nearest by default here
...
title = pygame.font.SysFont("dejavusans", 18, bold=True).render(
    "THUNDERBIRD  —  Design 5: ANCESTRAL SPIRIT  (Round 1)", True, (217, 255, 246))
