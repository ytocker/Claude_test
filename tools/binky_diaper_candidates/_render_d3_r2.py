"""Render PINNED TERRY (design_3) round 2 review sheet.

Hero product-shot + in-gameplay panel + 40px NEAREST truth reads on day and navy
night sky — the make-or-break icon-size view where the legs-under-the-nappy read
lives or dies.
"""
...
mod = importlib.import_module("tools.binky_diaper_candidates.design_3")
build = mod.build
...
sheet.fill((28, 26, 38))
title = FONT.render("BINKY diaper redo — DESIGN 3 PINNED TERRY — round 2", True, (255, 235, 200))
