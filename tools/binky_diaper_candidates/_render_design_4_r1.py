"""Round-1 review sheet for the SAGGY LOAD diaper (design_4).
...
night skies, so the asymmetric rear-droop silhouette can be judged at game
size — and that the heavy sag stays clear of the legs.
"""
...
def main():
    ...
    sheet.fill((30, 28, 38))
    _label(sheet, "BINKY — SAGGY LOAD diaper (design_4) — round 1", 20, 14,
           (255, 230, 180))
    ...
    sheet.blit(SMALL.render(
        "Front waistband high (y53); rear lobe sags back-left to y64 bulge "
        "(18,63) + shadow pool — legs poke clear below y65.",
        True, (200, 200, 210)), (20, H - 26))

    out = ("/home/user/skybit/docs/store_redesign/parrot/baby_parrot/"
           "diaper_redo/design_4/round_1.png")
