"""Round-1 review sheet for the SNUG CLOTH diaper (design_1).
...
night skies, so the worn-on-the-rump silhouette can be judged at game size.
"""
...
def main():
    ...
    sheet.fill((30, 28, 38))
    _label(sheet, "BINKY — SNUG CLOTH diaper (design_1) — round 1", 20, 14,
           (255, 230, 180))
    ...
    # Truth-reads: real native size scaled to 40px, then magnified 5x NEAREST.
    chip_box = 60
    mag = 4
    xs = 680
    # Day read.
    ...
    sheet.blit(SMALL.render(
        "Nappy band y53-62 hugs rump+belly; legs poke through clean below.",
        True, (200, 200, 210)), (20, H - 26))

    out = ("/home/user/skybit/docs/store_redesign/parrot/baby_parrot/"
           "diaper_redo/design_1/round_1.png")
