#!/usr/bin/env python3
"""
sun-arc  ·  flight-log arc v2  ·  arc_aspirational — direction E: the unreached goal is visible and magnetic.
...
def render_screen():
    ...
    # DAY COMPLETE — aspirational sun at the right terminus, glowing through the veil
    xdc, ydc = pos_u(1.0)
    # Warm bloom (BLEND_ADD — premultiplied falloff)
    ...
    # Aspirational hint — the player is invited to discover, not told what's there
    text(surf, "DISCOVER WHAT'S AHEAD", 8, center=(W // 2, 570),
         color=(180, 185, 200), shadow=None, track=2)
