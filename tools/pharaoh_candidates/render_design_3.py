"""Compose the RA (sun-falcon) review sheet (hero + gameplay + 40px truth read).

Headless: SDL_VIDEODRIVER=dummy SDL_AUDIODRIVER=dummy
PYTHONPATH=/home/user/skybit python tools/pharaoh_candidates/render_design_3.py
"""
import os
...
from tools.pharaoh_candidates.design_3 import build

OUT = "docs/store_redesign/costume/pharaoh/design_3/round_1.png"
TITLE = "DESIGN 3 — RA  round 2"
...
def _truth_read(box):
    ...
    half and a night sky half so the glowing solar disk is judged on both."""
