"""Compose the ANUBIS review sheet (hero + gameplay + 40px truth read).
...
from tools.pharaoh_candidates.design_2 import build

OUT = "docs/store_redesign/costume/pharaoh/design_2/round_1.png"
TITLE = "DESIGN 2 — ANUBIS  round 1"
