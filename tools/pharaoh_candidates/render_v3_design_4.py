"""Compose the THE SUN-GILDED review sheet (hero + gameplay + 40px truth read).
...
from tools.pharaoh_candidates.v3_design_4 import build

OUT = "docs/store_redesign/costume/pharaoh/v3_design_4/round_1.png"
TITLE = "v3 DESIGN 4 — THE SUN-GILDED  round 1"
...
def _truth_read(box):
    ...
    then magnify 3x so the reviewer judges the real on-screen read — split day
    sky (warm gold's worst case for washing out) vs night sky."""
