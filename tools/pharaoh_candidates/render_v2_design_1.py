"""Compose the HORUS review sheet (hero + gameplay + 40px truth read).
...
from tools.pharaoh_candidates.v2_design_1 import build

OUT = "docs/store_redesign/costume/pharaoh/v2_design_1/round_2.png"
TITLE = "v2 DESIGN 1 — HORUS  round 2"
