"""Compose the SARCOPHAGUS KING review sheet (hero + gameplay + 40px truth read).

Headless: SDL_VIDEODRIVER=dummy SDL_AUDIODRIVER=dummy PYTHONPATH=/home/user/skybit
python tools/pharaoh_candidates/render_v2_design_5.py
"""
import os
...
from tools.pharaoh_candidates.v2_design_5 import build

OUT = "docs/store_redesign/costume/pharaoh/v2_design_5/round_3.png"
TITLE = "v2 DESIGN 5 — SARCOPHAGUS KING  round 3"
