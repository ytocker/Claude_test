"""Compose the THE MUMMY review sheet (hero + gameplay + 40px truth read).

Headless: SDL_VIDEODRIVER=dummy SDL_AUDIODRIVER=dummy \
    PYTHONPATH=/home/user/skybit python <this>.
"""
import os
...
from tools.pharaoh_candidates.design_4 import build

OUT = "docs/store_redesign/costume/pharaoh/design_4/round_1.png"
TITLE = "DESIGN 4 — THE MUMMY  round 1"
...
def _truth_read(box):
    ...
    then magnify 3x so the reviewer judges the real on-screen read — half on a
    day sky, half on a night sky."""
