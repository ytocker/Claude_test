"""Compose the KHEPRI review sheet (hero + gameplay + 40px truth read).
...
from tools.pharaoh_candidates.v2_design_2 import build

OUT = "docs/store_redesign/costume/pharaoh/v2_design_2/round_3.png"
TITLE = "v2 DESIGN 2 — KHEPRI  round 3"
...
def _truth_read(box):
    ...
    then magnify 3x so the reviewer judges the real on-screen read, on day +
    night halves."""
