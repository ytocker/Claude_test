"""Compose the JEWELED PHARAOH review sheet (hero + gameplay + 40px truth read).
...
from tools.pharaoh_candidates.v3_design_2 import build

OUT = "docs/store_redesign/costume/pharaoh/v3_design_2/round_1.png"
TITLE = "v3 DESIGN 2 — THE JEWELED PHARAOH  round 1"
