"""Compose the DIVINE PRIEST review sheet (hero + gameplay + 40px truth read).

Headless: SDL_VIDEODRIVER=dummy SDL_AUDIODRIVER=dummy PYTHONPATH=/home/user/skybit python <this>.
"""
import os
...
from tools.pharaoh_candidates.v3_design_3 import build

OUT = "docs/store_redesign/costume/pharaoh/v3_design_3/round_1.png"
TITLE = "v3 DESIGN 3 — THE DIVINE PRIEST  round 1"
