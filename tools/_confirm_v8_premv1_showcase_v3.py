"""premium-v1 showcase v3: BEFORE + 5 concepts + user-directed hybrid (#6)."""
...
OUT_PNG = os.path.join(BASE, "showcase_v3.png")
...
def make_showcase():
    ...
    draw.text((CANVAS_W // 2, HEADER_H // 2),
              "CONFIRM POPUP · PREMIUM ENHANCE v1 · + HYBRID",
