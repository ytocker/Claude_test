"""Compose THE PRO review sheet (hero + gameplay + 40px truth read).
...
OUT = "docs/store_redesign/costume/basketball/design_1/round_2.png"
TITLE = "DESIGN 1 — THE PRO (Basketball)  round 2 (RE-ROLL rebuild)"
