"""Compose the STREETBALLER review sheet (hero + gameplay + 40px truth read).
...
from tools.basketball_candidates.design_2 import build

OUT = "docs/store_redesign/costume/basketball/design_2/round_1.png"
TITLE = "DESIGN 2 — THE STREETBALLER (Basketball)  round 1"
...
def _truth_read(box):
    """The 40px-in-motion test: shrink the bird to a ~40px read on NEAREST then
    magnify 3x so the reviewer judges the real on-screen read on day + night."""
