"""Round-1 review sheet for panda DESIGN 2 (BAMBOO MUNCHER).
...
in-motion read can be judged directly.
"""
import os
...
def main():
    ...
    # Title.
    title = FONT.render("PANDA DESIGN 2 — BAMBOO MUNCHER  (round 1)", True, (235, 235, 240))
    ...
    out = "/home/user/skybit/docs/store_redesign/animal/panda/design_2/round_1.png"
