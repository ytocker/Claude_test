"""Bottom-frame gems — option E: shelf-expands.

Shelf top moves up while bottom stays fixed, making shelf taller and more dominant.
SHELF_Y=215, SHELF_H=107, CHIP_CY=246, BTN_CY=276.
Shelf bottom stays at 215+107=322 (same as original 235+87=322).
Bottom gems at cy=309 have 7px clearance below button bottom (276+15=291, gem top=298).

Sheet: left=AFFORDABLE, right=UNAFFORDABLE, 444×412
Output → docs/store_confirm_shelf_v3/bottom-gems/shelf-expands/round_1.png
"""
import os, sys, math
...
SHELF_X, SHELF_Y, SHELF_W, SHELF_H = 13, 215, 174, 107
CHIP_CY                            = 246
...
OUT = os.path.abspath(os.path.join(os.path.dirname(__file__), "..",
      "docs", "store_confirm_shelf_v3", "bottom-gems", "shelf-expands", "round_1.png"))
canvas.save(OUT)
