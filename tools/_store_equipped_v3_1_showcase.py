"""Phase 5 showcase: equipped state v3.1 — BEFORE (regalia frame only) + 5 symbol variants."""
import os, sys
...
# ── Regalia frame helper (exact copy from v3 regalia_frame r2) ────────────────
...
# ── BEFORE panel: regalia frame only, no symbol ───────────────────────────────
...
CONCEPTS = [
    ("corner_studs",       "CORNER STUDS"),
    ("sovereign_seal",     "SOVEREIGN SEAL"),
    ("corner_sash",        "CORNER SASH"),
    ("equipped_check_chip","CHECK CHIP"),
    ("dome_jewel",         "DOME JEWEL"),
]

panels = [("FRAME ONLY", before_panel)]
for slug, label in CONCEPTS:
    path = os.path.join("docs/store_equipped_v3_1", slug, "round_2.png")
...
title = fh.render("store card — EQUIPPED v3.1 · regalia-frame + symbol variants",
                  True, (240, 224, 180))
...
out = "docs/store_equipped_v3_1/showcase.png"
