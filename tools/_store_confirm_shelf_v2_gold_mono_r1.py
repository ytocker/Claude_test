"""Round 1 — shelf concept 'gold-mono' (store_confirm_shelf_v2 series).
...
Output → docs/store_confirm_shelf_v2/gold-mono/round_1.png
"""
import sys, os, math
...
def _btn(big, btn_rect, label, locked=False):
    ...
    bevel; only `label` (and, when the wallet is short, `locked`'s dimming)
    tells them apart. Restraint is the whole idea: the rim is the ornament."""
    rad = m(BTN_RAD)
    if locked:
        stops    = [(0.0, (28, 26, 38)), (1.0, (16, 14, 26))]
        lab_col  = (85, 83, 100)
        sheen    = 10
        bright_a = 130            # gold rim survives, only dimmed, when locked
    else:
        stops    = [(0.0, (34, 32, 46)), (1.0, (20, 18, 30))]
        lab_col  = (215, 205, 235)
        sheen    = 22
        bright_a = 210
...
OUT = "docs/store_confirm_shelf_v2/gold-mono/round_1.png"
