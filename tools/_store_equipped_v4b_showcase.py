#!/usr/bin/env python3
"""
Showcase figure for store_equipped_v4b — 5 gold/cream equipped-indicator concepts, round 2.
...
CONCEPTS = [
    ("gold_pill_equipped",      "GOLD PILL\nEQUIPPED"),
    ("warm_glow_pip_gold",      "WARM GLOW\nPIP GOLD"),
    ("gold_stud_seal",          "GOLD STUD\nSEAL"),
    ("bottom_rail_nameplate",   "BOTTOM RAIL\nNAMEPLATE"),
    ("lit_frame_filament",      "LIT FRAME\nFILAMENT"),
]

BASE = os.path.join(os.path.dirname(__file__), "..", "docs", "store_equipped_v4b")
...
tt = title_f.render("equipped v4b — 5 concepts · round 2 showcase", True, GOLD)
