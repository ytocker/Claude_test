"""Compose the design_4 (SMOKE PHANTOM) review sheet. Scratch only."""
...
CONCEPT = "design_4 - SMOKE PHANTOM (Mystic Shadow-Clone Ninja, LEGENDARY)"
BG = (18, 16, 26)
CARD = (28, 24, 40)
INK = (236, 230, 250)
SUB = (150, 140, 175)
...
def main():
    ...
    # Clip the gameplay crop to a rounded rect via an alpha mask.
    ...
    # ── FILMSTRIP (4 flap frames, smoke/clone motion) ──
    strip_y = 470
    pygame.draw.line(sheet, (60, 54, 80), (28, strip_y - 12),
                     (W - 28, strip_y - 12), 1)
    text(sheet, "4-FRAME FILMSTRIP - animated smoke / clone / glow",
         (28, strip_y - 8))
    cell = 180
    ...
    out = "/home/user/skybit/docs/store_redesign/costume/ninja/design_4/round_1.png"
