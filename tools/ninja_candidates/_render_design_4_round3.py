"""Compose the design_4 (SMOKE PHANTOM) ROUND 3 review sheet. Scratch only.

Same shared harness as rounds 1-2 (hero + gameplay + 40px NEAREST truth read +
...
CONCEPT = "design_4 - SMOKE PHANTOM (Mystic Shadow-Clone Ninja, LEGENDARY) - ROUND 3"
BG = (18, 16, 26)
CARD = (28, 24, 40)
INK = (236, 230, 250)
SUB = (150, 140, 175)
...
def main():
    ...
    out = "/home/user/skybit/docs/store_redesign/costume/ninja/design_4/round_3.png"
