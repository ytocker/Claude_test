"""Compose the IRON RONIN round-2 review sheet: hero shot + in-gameplay crop +
a 40px NEAREST truth read sampled x3 (flat hero, gameplay-tilt, flap frame).
Save under docs/. Exploration only — production art untouched.
"""
import os
...
CONCEPT = "IRON RONIN  ·  Armored Samurai-Ninja  ·  round_2"
OUT = "/home/user/skybit/docs/store_redesign/costume/ninja/design_3/round_2.png"
...
def main():
    ...
    _label(sheet, "design_3 · round_2 · darkened oxblood base + welded "
                  "iron/gold kabuto bowl + flared sode · exploration "
