"""Compose the design_2 (CRIMSON FANG) ROUND 2 review sheet: hero shot +
...
OUT = "docs/store_redesign/costume/ninja/design_2/round_2.png"
TITLE = "CRIMSON FANG — Blood Assassin Kunoichi  (ninja design_2 · round 2)"
...
def main():
    ...
    _label(sheet, "bigger crossed-kunai X · flat obi (no XXX) · single-slit "
                  "mask · lifted scarf clearing the tail", 22, 42, sz=13, col=SUB)
