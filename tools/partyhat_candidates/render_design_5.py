"""Render the DESIGN 5 (Balloon Bouquet) review sheet. SCRATCH ONLY."""
import os
import sys
...
from tools.partyhat_candidates import design_5  # noqa: E402
...
def main():
    ...
    _label(sheet, "DESIGN 5  BALLOON BOUQUET  -  party hat redesign  (round 2)",
           pad, 12, (255, 210, 63))
    x = pad
    ...
    out = os.path.join(_ROOT, "docs/store_redesign/hats/partyhat/design_5/round_2.png")
