"""Shelf-redesign: gem-cradle-tab w2 (large downward shift, Δ25).
...
w2 — Δ25:
  SHELF_Y=253, SHELF_H=75  # shelf_bottom=328 (pinned)
  BTN_CY=274, BTN_H=26
  CHIP_CY=306, CHIP_H=26    # chip_bottom=319
  BOT_GEM_CY=309            # fixed

Sheet: left=AFFORDABLE, right=UNAFFORDABLE, 444×412
Output → docs/store_confirm_shelf_v3/shelf-redesign/gem-cradle-tab/w2/round_1.png
"""
import os, sys, math
...
# w2 — Δ25 downward shift; shelf bottom pinned at card bottom (328).
SHELF_X, SHELF_Y, SHELF_W, SHELF_H = 13, 253, 174, 75  # SHELF_H = 328 - SHELF_Y
BTN_W, BTN_H, BTN_RAD              = 76, 26, 9
BTN_CY, BTN_GAP                    = 274, 8
BUY_CX = CX - (BTN_W + BTN_GAP) // 2
CAN_CX = CX + (BTN_W + BTN_GAP) // 2
CHIP_W, CHIP_H, CHIP_RAD           = 88, 26, 8
CHIP_CY                            = 306   # chip_bottom=319
...
draw.text((CANVAS_W // 2, MARGIN + HDR_H // 2),
          "gem-cradle-tab w2 | AFFORDABLE / UNAFFORDABLE",
...
OUT = os.path.abspath(os.path.join(os.path.dirname(__file__), "..",
      "docs", "store_confirm_shelf_v3", "shelf-redesign", "gem-cradle-tab", "w2", "round_1.png"))
...
print(f"w2  size:{img.size}  btn:{btn}  chip:{chip}  gem_l:{gem_l}")
