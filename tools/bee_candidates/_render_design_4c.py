"""Compose the RED ADMIRAL (design_4c) review sheet: a hero product shot, an
...
Headless: SDL_VIDEODRIVER=dummy python tools/bee_candidates/_render_design_4c.py
"""
import os
...
def _gameplay_panel(source, w, h, phase):
    """gameplay_panel, but at an arbitrary biome phase so we can show the
    costume over both day and night skies."""
...
def main():
    ...
    day = _gameplay_panel(build, gw, box, 0.0)
    night = _gameplay_panel(build, gw, box, NIGHT_PHASE)
