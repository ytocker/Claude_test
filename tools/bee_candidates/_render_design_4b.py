"""Compose the AZURE MONARCH (design_4b) review sheet: a hero product shot,
...
Headless: SDL_VIDEODRIVER=dummy python tools/bee_candidates/_render_design_4b.py
"""
import os
...
def main():
    ...
    sy = head + box + 28
    _label(sheet, "FLAP STRIP  (frames 0-3 — iridescent flash slides across the wing each beat)",
