"""Build docs/flight_log_arc_v2/showcase_r4.png — 5 concept round-2 panels side by side."""
import os
...
SLUGS = ["radar", "constellation", "transit", "cinema", "glass"]
LABELS = ["A", "B", "C", "D", "E"]
...
# Header
hdr = font_hdr.render("FLIGHT LOG  ·  5 CONCEPTS  ·  ROUND 2", True, GOLD)
...
for i, (slug, label, verdict) in enumerate(zip(SLUGS, LABELS, VERDICTS)):
    ...
    # Footer — slug name (top line) + verdict (bottom line)
...
out = os.path.join(FEATURE_DIR, "showcase_r4.png")
