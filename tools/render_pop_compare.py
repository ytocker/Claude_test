"""Pop-art fly variant comparison figure.

Renders the POP FLY reference (Design 5) + 5 colour variants side by side,
each as Pip mid-flight over a real daytime biome scene, plus a hero shot and
a 40px truth read.
Saves docs/store_redesign/animal/fly/pop_final_comparison.png.
"""
import os
import sys
...
from tools.fly_candidates.design_5 import build as build_ref
from tools.fly_candidates.pop_v1 import build as build_v1
from tools.fly_candidates.pop_v2 import build as build_v2
from tools.fly_candidates.pop_v3 import build as build_v3
from tools.fly_candidates.pop_v4 import build as build_v4
from tools.fly_candidates.pop_v5 import build as build_v5
...
out_path = os.path.join(out_dir, "pop_final_comparison.png")
