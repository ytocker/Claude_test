"""Bottom-frame gems — option B: buttons-lift.

Raise buttons only; shelf top stays near original. Chip↔button gap tightens.
SHELF_Y=230, CHIP_CY=248, BTN_CY=278 (shelf was 235, buttons were 302).
Bottom gems at cy=309 have 5px clearance below button bottom (278+15=293, gem top=298).

Sheet: left=AFFORDABLE, right=UNAFFORDABLE, 444×412
Output → docs/store_confirm_shelf_v3/bottom-gems/buttons-lift/round_1.png
"""
import os, sys, math
...
SHELF_X, SHELF_Y, SHELF_W, SHELF_H = 13, 230, 174, 87
CHIP_CY                            = 248
BTN_W, BTN_H, BTN_RAD              = 76, 30, 9
BTN_CY, BTN_GAP                    = 278, 8
...
draw.text((CANVAS_W // 2, MARGIN + HDR_H // 2),
          "Bottom gems B: buttons-lift  |  AFFORDABLE / UNAFFORDABLE",
...
OUT = os.path.abspath(os.path.join(os.path.dirname(__file__), "..",
      "docs", "store_confirm_shelf_v3", "bottom-gems", "buttons-lift", "round_1.png"))
canvas.save(OUT)
