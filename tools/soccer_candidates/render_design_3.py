"""Soccer v3 D3 Captain — render sheet."""
import os, sys
...
os.makedirs("docs/store_redesign/costume/soccer/design_3", exist_ok=True)
out = "docs/store_redesign/costume/soccer/design_3/round_2.png"
