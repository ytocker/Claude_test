"""Compose the THE REFEREE review sheet (hero + gameplay + 40px truth read).
...
def _truth_read(box):
    ...
    then NEAREST-magnify 3x so the reviewer judges the real on-screen read. The
    black kit's night read is the risk, so day-bright + night-dark swatches."""
