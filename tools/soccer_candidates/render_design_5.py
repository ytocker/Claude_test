"""Compose the THE ULTRA review sheet (hero + gameplay + 40px truth read).
...
OUT = "docs/store_redesign/costume/soccer/design_5/round_1.png"
TITLE = "DESIGN 5 — THE ULTRA (Soccer fan: scarf + bobble hat)  round 1"
...
def _truth_read(box):
    ...
    then magnify 3x so the reviewer judges the real on-screen read on a
    day-bright and a night-dark swatch."""
