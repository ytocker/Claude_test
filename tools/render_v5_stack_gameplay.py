"""Render the 5 V5 skyscraper picker variants as full-frame gameplay shots.

Output:
  docs/kfc_pillar_variants/v5_stack/v5_stack1..5.png
  docs/kfc_pillar_variants/v5_stack/compare.png

Run from the repo root:

    PYTHONPATH=. python tools/render_v5_stack_gameplay.py
"""
import math
import os
import random
...
from render_v5_stack_variants import install_variant, V5_STACK_VARIANTS  # noqa: E402
...
def main():
    ...
    out_dir = os.path.join("docs", "kfc_pillar_variants", "v5_stack")
    os.makedirs(out_dir, exist_ok=True)

    full_frames = {}

    for key in V5_STACK_VARIANTS:
        label, _ = V5_STACK_VARIANTS[key]
    ...
    items = list(V5_STACK_VARIANTS.items())
    n = len(items)
