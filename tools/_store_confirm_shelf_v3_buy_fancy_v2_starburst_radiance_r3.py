...
def _draw_rays(big):
    ...
    for i in range(N_RAYS):
        ...
        if i % 2 == 0:
            ray_col = (*sc.CARD_RING_BRIGHT, 110)          # gold
        else:
            ray_col = (160, 110, 220, 130)                 # lilac
    ...
    sc.soft_glow(ray_layer, cx_r, cy_r, m(15), sc.CARD_RING_BRIGHT,
                 peak_alpha=60)
...
draw.text((CANVAS_W // 2, MARGIN + HDR_H // 2),
          "starburst-radiance (B) r3  |  AFFORDABLE / UNAFFORDABLE",
...
OUT = os.path.join(os.path.dirname(__file__), "..",
                   ...
                   "starburst-radiance", "round_3.png")
