#!/usr/bin/env python3
"""
shelf-chip  ·  store buy-confirmation popup v4  ·  round 1
...
def _draw_button(big, rect, rad, label, locked=False):
    ...
    if locked:
        ...
        # Warm indigo reads as shelf-native and tappable without stealing the
        # cream chip's spotlight — so neither action out-shouts the other.
        stops = [(0.0, (70, 65, 110)), (1.0, (50, 46, 82))]
        lab_col = (220, 210, 240)
        sheen = 28
...
hdr = store_mod._font(16, True).render(
    "shelf-chip v4 R1 · CREAM CHIP + TWIN IDENTICAL BUTTONS", True, (226, 208, 150))
...
OUT = os.path.join(os.path.dirname(__file__), "..",
                   "docs", "store_confirm_popup_v4", "shelf-chip", "round_1.png")
