"""Bottom-frame gems — option C: slim-buttons (R2).

R2 changes over R1:
  - Restore BTN_H=28 (was 24 — too slim, hurt CTA weight) → 76×28 pill.
  - Rebalance shelf: SHELF_Y=222, CHIP_CY=240, BTN_CY=274 →
    3px chip-button gap, 10px gem clearance below the buttons.
  - Tame affordable bottom-gem aura (peak 45, radius m(14)) so it stops
    competing with the BUY/CANCEL buttons above.
  - NOT ENOUGH text at m(293), safely between btn_bottom (288) and gem_top (298).

Sheet: left=AFFORDABLE, right=UNAFFORDABLE, 444×412
Output → docs/store_confirm_shelf_v3/bottom-gems/slim-buttons/round_2.png
"""
import os, sys, math
...
# Option C: slim buttons with restored CTA weight (BTN_H=28) + rebalanced shelf
...
draw.text((CANVAS_W // 2, MARGIN + HDR_H // 2),
          "Bottom gems C: slim-buttons R2  |  AFFORDABLE / UNAFFORDABLE",
...
OUT = os.path.abspath(os.path.join(os.path.dirname(__file__), "..",
      "docs", "store_confirm_shelf_v3", "bottom-gems", "slim-buttons", "round_2.png"))
canvas.save(OUT)
