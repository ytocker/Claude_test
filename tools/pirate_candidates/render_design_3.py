"""Compose the SWASHBUCKLER review sheet (hero + gameplay + 40px truth read).
...
OUT = "docs/store_redesign/costume/pirate/design_3/round_1.png"
TITLE = "DESIGN 3 — SWASHBUCKLER  (Armed for a Fight: cutlass + baldric + flintlock)"
