"""Compose the GOLD-LADEN review sheet (hero + gameplay + 40px truth read).
...
OUT = "docs/store_redesign/costume/pirate/design_5/round_1.png"
TITLE = "DESIGN 5 — GOLD-LADEN  (The Treasure Raider)"
...
def _truth_read(box):
    """The 40px-in-motion test: render the bird frame, NEAREST shrink it to a
    ~40px bird, then magnify 3x on day + night swatches so the reviewer judges
    the real on-screen read."""
