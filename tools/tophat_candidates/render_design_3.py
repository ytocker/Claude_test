"""Compose THE LORD review sheet (hero + gameplay + 40px truth read).
...
from tools.tophat_candidates.design_3 import build

OUT = "docs/store_redesign/costume/tophat/design_3/round_1.png"
TITLE = "DESIGN 3 — THE LORD  round 2"
