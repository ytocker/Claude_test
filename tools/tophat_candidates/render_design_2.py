"""Compose THE RINGMASTER review sheet (hero + gameplay + 40px truth read).
...
from tools.tophat_candidates.design_2 import build

OUT = "docs/store_redesign/costume/tophat/design_2/round_1.png"
TITLE = "DESIGN 2 — THE RINGMASTER  round 1"
