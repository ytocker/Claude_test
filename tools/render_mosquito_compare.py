"""Final comparison figure for the MOSQUITO animal-skin exploration.
...
Saves docs/store_redesign/animal/mosquito/final_comparison.png.
"""
import os
import sys
...
from tools.mosquito_candidates.design_1 import build as build1
from tools.mosquito_candidates.design_2 import build as build2
from tools.mosquito_candidates.design_3 import build as build3
from tools.mosquito_candidates.design_4 import build as build4
from tools.mosquito_candidates.design_5 import build as build5
...
def _gameplay_panel(build_fn, w, h):
    ...
    # Fit crop inside the scene: scale to fit both dimensions.
...
out_dir = os.path.join(os.path.dirname(os.path.dirname(os.path.abspath(__file__))),
                       "docs", "store_redesign", "animal", "mosquito")
