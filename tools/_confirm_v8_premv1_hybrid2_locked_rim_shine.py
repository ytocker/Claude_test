"""The locked design: G8 rim-shine perimeter at x1.4 thickness.

Two columns — the design currently live in the game next to the locked
pick — popup / card / category each, for a clean final reference.

Output: colorways/locked_rim_shine_v1.png
"""
import os
import sys
...
def main():
    ...
    try:
        ...
        panels.append((f"LOCKED · G8 rim-shine ×{LOCKED_THICKNESS}",
                       "the rim's layered gold gradient as the perimeter, "
                       f"stroke stack at ×{LOCKED_THICKNESS}",
        ...
        idr.text((MARGIN, 16),
                 "LOCKED design · G8 rim-shine perimeter at ×1.4 · "
        ...
        out = os.path.join(os.path.dirname(os.path.dirname(os.path.abspath(__file__))),
                           ...
                           "colorways", "locked_rim_shine_v1.png")
        strip.save(out)
