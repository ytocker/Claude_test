"""Build docs/flight_log_arc_v2/showcase.png — 5 refined sun-arc directions."""
import os
...
LABELS = {
    "arc_clean":        "A · ARC CLEAN",
    "arc_void":         "B · ARC VOID",
    "arc_count":        "C · ARC COUNT",
    "arc_minimal":      "D · ARC MINIMAL",
    "arc_aspirational": "E · ARC ASPIRATIONAL",
}
IDS = ["A", "B", "C", "D", "E"]
...
hdr = font_hdr.render("FLIGHT LOG ARC V2  ·  5 REFINED DIRECTIONS", True, GOLD)
