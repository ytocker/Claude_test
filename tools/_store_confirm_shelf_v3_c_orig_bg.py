"""Hybrid: twilight-vault chip + buttons on original indigo shelf.

Takes from design C (twilight-vault):
  - Turquoise BUY button (fills, label, font 14, gold bevel)
  - Dimmed-teal CANCEL button (fills, label, font 13, gold bevel)
  - Dark-teal chip (dimensions 112×34, gold price, coin r=15, gold hairline)

Shelf background: original _draw_confirm indigo
  - Affordable stops: (28,30,62) → (14,16,40)
  - Lip: (115,106,140)
  - Walls: original purple-lit left / dark right

Sheet: left=AFFORDABLE, right=UNAFFORDABLE, 444×412
Output → docs/store_confirm_shelf_v3/c-orig-bg/round_1.png
"""
import os, sys, math
...
shelf_px = aff.getpixel((CX, SHELF_Y + 10))
print(f"shelf body (100,{SHELF_Y+10}): {shelf_px}  — should be indigo (near 28,30,62)")
