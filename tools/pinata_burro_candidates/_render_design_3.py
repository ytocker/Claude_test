"""Round-1 review sheet for burro piñata DESIGN 3 (RIBBON STREAMER TAIL).
...
in-motion read of the swinging ribbon can be judged directly.
"""
import os
...
spec = importlib.util.spec_from_file_location(
    "design_3", "/home/user/skybit/tools/pinata_burro_candidates/design_3.py")
...
def _night_panel(source, w, h):
    ...
    cycle, to confirm the festival ribbon colours still pop after dark."""
...
def main():
    ...
    title = FONT.render(
        "BURRO PIÑATA — DESIGN 3: RIBBON STREAMER  (round 1)", True, (235, 235, 240))
    sheet.blit(title, (16, 10))

    PW, PH = 210, 300
    y0 = 40
    cols = [
        ("DAY GAMEPLAY", gameplay_panel(mod.build, PW, PH)),
        ("NIGHT GAMEPLAY", _night_panel(mod.build, PW, PH)),
        ("HERO", hero_panel(mod.build, PH)),
    ]
    x = 16
    ...
    out = "/home/user/skybit/docs/store_redesign/animal/pinata_burro/design_3/round_1.png"
