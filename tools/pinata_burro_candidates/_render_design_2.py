"""Round-1 review sheet for burro piñata DESIGN 2 (DONKEY TUFT TAIL).
...
in-motion read of the new tail can be judged directly.
"""
import os
...
spec = importlib.util.spec_from_file_location(
    "design_2", "/home/user/skybit/tools/pinata_burro_candidates/design_2.py")
...
def _night_panel(source, w, h):
    ...
    cycle, to confirm the cream stub + dark tuft still read after dark."""
...
def main():
    ...
    title = FONT.render(
        "BURRO PIÑATA — DESIGN 2: DONKEY TUFT (round 3)", True, (235, 235, 240))
    ...
    out = "/home/user/skybit/docs/store_redesign/animal/pinata_burro/design_2/round_3.png"
