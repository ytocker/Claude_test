"""Round-1 review sheet for burro piñata DESIGN 5 (STAR SPIKE TAIL).
...
in-motion read of the shimmering festival star can be judged directly.
"""
import os
...
spec = importlib.util.spec_from_file_location(
    "design_5", "/home/user/skybit/tools/pinata_burro_candidates/design_5.py")
...
def _night_panel(source, w, h):
    ...
    cycle, to confirm the festival star still pops after dark."""
...
def main():
    ...
    title = FONT.render(
        "BURRO PIÑATA — DESIGN 5: STAR SPIKE  (round 1)", True, (235, 235, 240))
    ...
    out = "/home/user/skybit/docs/store_redesign/animal/pinata_burro/design_5/round_1.png"
