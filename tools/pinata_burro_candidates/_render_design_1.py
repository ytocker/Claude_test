"""Round-3 review sheet for burro piñata DESIGN 1 (TASSEL TAIL).
...
def main():
    ...
    title = FONT.render(
        "BURRO PIÑATA — DESIGN 1: TASSEL TAIL  (round 3)", True, (235, 235, 240))
    ...
    out = "/home/user/skybit/docs/store_redesign/animal/pinata_burro/design_1/round_3.png"
