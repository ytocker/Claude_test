"""Round-1 review sheet for burro piñata DESIGN 4 (CREPE PLUME TAIL).
...
in-motion read of the peacock-fan tail can be judged directly.
"""
import os
...
spec = importlib.util.spec_from_file_location(
    "design_4", "/home/user/skybit/tools/pinata_burro_candidates/design_4.py")
...
def _night_panel(source, w, h):
    ...
    cycle, to confirm the festival-coloured fan still reads after dark."""
...
def main():
    ...
    title = FONT.render(
        "BURRO PIÑATA — DESIGN 4: CREPE PLUME (round 3)", True, (235, 235, 240))
    ...
    out = "/home/user/skybit/docs/store_redesign/animal/pinata_burro/design_4/round_3.png"
