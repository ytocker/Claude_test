"""Headless preview for the procedural straw hat.

Renders draw_hat at three sizes on a dark-navy field, each seated on a
faint grey placeholder head-circle, and writes preview.png.

Run: SDL_VIDEODRIVER=dummy python docs/hats/strawhat/preview.py
"""
import os
import sys
import pathlib
...
def main():
    ...
    # Lay the three product shots out in a row, baseline-aligned so the size
    ...
    title = font.render("STRAW HAT  -  procedural store hat (facing +1)",
                        True, LABEL)
