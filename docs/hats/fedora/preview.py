"""Headless preview for the procedural fedora.
...
Run: SDL_VIDEODRIVER=dummy python docs/hats/fedora/preview.py
"""
import os
import sys
import pathlib
...
def main():
    ...
    title = font.render("FEDORA  -  procedural store hat (facing +1)",
                        True, LABEL)
