"""Final 5-up comparison: every supermarket-cart concept in the real gameplay frame.
...
Run:
    SDL_VIDEODRIVER=dummy SDL_AUDIODRIVER=dummy python docs/cart/_render_compare.py
"""
