"""mid-crib-a: crib length between classic-seat and short-crib — 4 courses, sticks to r(15)."""
import os, sys
...
_COURSES = nb.COURSES[:4]
_STICK_BOTTOM = round(15 * nb._NEST_S)
...
if __name__ == '__main__':
    nb.render_pair(draw_slot, 'docs/nest-mouth/mid-crib-a/pair.png')
