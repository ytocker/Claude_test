"""len-1: crib length step between classic-seat (D1) and short-crib (D2).
...
_OFFS = [2, 5, 8, 11, 13]
_COLS = [nb._NEST_TWIG_BRIGHT, nb._NEST_TWIG_MID, nb._NEST_TWIG_BRIGHT, nb._NEST_TWIG_MID, nb._NEST_TWIG_BRIGHT]
_STICKS = 13
...
if __name__ == '__main__':
    nb.render_pair(draw_slot, 'docs/nest-mouth/len-1/pair.png')
