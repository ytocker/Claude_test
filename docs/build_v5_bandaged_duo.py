"""
4-panel comparison: ORIGINAL · V3 battle-bloodshot · bandaged-cheek (V5) · bandaged-breast (V5).
Output: docs/hurt-parrot-v5-bandaged-duo.png
"""
...
PANELS = [
    ...
    ("bandaged-breast", "bandaged-\nbreast",  lambda: _get_v5("bandaged-breast"), (255, 210,  80), "V5"),
]
...
def main():
    ...
    title = "HURT PARROT · LAST LIFE · ORIGINAL · V3 · V5 BANDAGED DUO"
    ...
    out_path = os.path.join(REPO, "docs", "hurt-parrot-v5-bandaged-duo.png")
