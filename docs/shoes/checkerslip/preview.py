"""Headless preview for the CHECKER SLIP shoe core.

Renders draw_shoe at hero / mid / foot sizes in a labelled row on a dark navy
field so the checkerboard, foxing stripe, and collar read across the full scale
range. Run with SDL_VIDEODRIVER=dummy; saves preview.png beside this file.
"""
import os
