"""
V15 smooth-taper-weave — 5 refined size options between 85% and 70%.
Parrot stays at full size; only the nest scales.
Each panel footer shows ID number + scale %.
"""
import os, sys, math
...
def make_params(s, cx):
    ...
    bird_h       = 34   # parrot always full size
...
# 5 options evenly spaced between 85% and 70%
VARIANTS = [
    (0.72, "opt_72", "ID 1  72%"),
    (0.74, "opt_74", "ID 2  74%"),
    (0.76, "opt_76", "ID 3  76%"),
...
hdr = "SMOOTH-TAPER WEAVE  \xb7  V15  \xb7  72% – 80%"
try:
...
SHOWCASE = f"{OUT_DIR}/size_refined.png"
