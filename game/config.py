...
ROCK_PER_PILLAR_MAX      = 16     # rocks scattered per pillar at full density; count scales up over the slow buildup so the field is well-populated by the time geysers arrive
