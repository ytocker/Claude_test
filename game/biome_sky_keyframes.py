...
_ALPINE_HAZE_KF = [
    ...
    (0.47, dict(sky_top=(37, 30, 70), sky_mid=(118, 59, 80), sky_bot=(167, 84, 68), horizon=(188, 78, 52), star_alpha=88)),
    (0.52, dict(sky_top=(28, 30, 64), sky_mid=(68, 42, 68), sky_bot=(99, 57, 66), horizon=(127, 68, 61), star_alpha=156)),
