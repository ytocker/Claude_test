...
_SEAT = {
    ...
    "skin_hat_strawhat":  {"hw": 32, "dx": -1, "dy": -1},
    "skin_hat_beanie":    {"hw": 28, "dy": 2},
    "skin_hat_beret":     {"dx": -10, "dy": 6},
    "skin_hat_buckethat": {"hw": 32, "dx": -2, "dy": 2},
    "skin_hat_flatcap":   {"dx": 1, "dy": 2},
    "skin_hat_propeller": {"dx": -4},
    "skin_hat_trucker":   {"dx": -1, "dy": 2},
    "skin_hat_snapback":  {"dx": -2, "dy": 4},
    "skin_hat_gradcap":   {"hw": 34, "dx": -8, "dy": 7},
    "skin_hat_chef":      {"hw": 27, "dx": 2, "dy": 2},
    "skin_hat_bowler":    {},
    "skin_hat_fedora":    {"hw": 32, "dy": 1},
    "skin_hat_sombrero":  {"hw": 38, "dy": 5},
    "skin_hat_santa":     {"dx": -2, "dy": -4},
    "skin_hat_nycap":     {"hw": 32, "dx": -7, "dy": 9},
}
