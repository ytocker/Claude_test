...
def play_genie() -> None:
    # Three-layer "magical" stitch using only existing OGGs (per the
    # no-new-assets rule): ethereal ghost-whoosh as the base, sparkly
    # coin_triple chime as the "wish reveal" overlay, soft poof as
    # the lamp-pop bookend.
    _play("ghost", 0.70)
    _play("coin_triple", 0.85)
    _play("poof", 0.40)
