...
def _build_hero(item_id: str) -> pygame.Surface:
    ...
    # the 64px redraws all fill the hero box consistently. Shoes reveal as their
    # product-shot icon (the sneaker itself) rather than Pip wearing them.
    src = parrot.get_skin_icon(item_id) or parrot.get_skin_frame(item_id, 1, 0.0)
